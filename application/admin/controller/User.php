...
class User extends Controller
{
    ...
    //     }
    //     $user = Db::table("t_admin_userinfo")->where("f_uid = {$ret_login['uid']}")->find();
    //     session::set('ck',$ret_login['ck']);
    //     session::set('uid',$ret_login['uid']);
    //     session::set('uname',$user['f_realname']);
    //     $resinfo = array(
    //         'ck' => $ret_login['ck'],
    //         'uid' => $ret_login['uid'],
    //     );
    ...
    public function paylog()
    {
        ...
        return view('paylog',['list'=>$list,'sex'=>$sex]);
    }
    ...
    public function checklog()
    {
        ...
        $empty = '<td colspan="7" class="empty">没有数据</td>';
return view('checklog',['list'=>$list,'paytype'=>$paytype,'channel'=>$channel,'empty'=>$empty]);
    }
    ...
    public function paydetails()
    {
        ...
        // var_dump($list);exit;
        $empty = '<td colspan="7" class="empty">没有数据</td>';
        return view('paydetails',['list'=>$list,'tradetype'=>$tradetype,'inout'=>$inout,'empty'=>$empty]);    }
