...
class DishesModel extends Model
{
    ...
    public function getDishesListBysidNoPage($shopid){
        $disheslist = Db::table('t_admin_food_dishes')
            ->alias('a')
            ->field('a.f_id id, a.f_icon icon, a.f_name dishesname, format(a.f_price,2) price, a.f_tastesid tastesid, b.f_cname classifyname, c.f_cname cuisinename,a.f_desc as food_desc,a.f_salenum as salenum,a.f_discount as discount')
            ->join('t_food_classify b','a.f_classid = b.f_cid','left')
            ->join('t_food_cuisine c','a.f_cuisineid = c.f_cid','left')
     ...
     * 根据店铺ID获取菜品列表信息
     */
    public function getDishesListBysid($shopid, $page = 0, $pagesize = 50){
